                ...
                <div className="relative max-w-xl mx-auto">
                    ...
                    <div className="text-center">
                        ...
                        <p className="mt-4 text-lg leading-6 text-gray-500">
                            Please fill out this form to receive materials for an at-home mock. If you have any questions, you can reach us at contact@hiemile.com or {" "}
                    ...
                    <div className="mt-12">
                        <form name="mock" action="/thankyou" method="POST" className="grid grid-cols-1 row-gap-6 sm:grid-cols-2 sm:col-gap-8" data-netlify="true">
                            <input type="hidden" name="form-name" value="mock" />
                            <div>
