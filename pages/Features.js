                    ...
                    <ul className="md:grid md:grid-cols-2 md:col-gap-8 md:row-gap-10">
                        ...
                        <li className="mt-10 md:mt-0">
                            ...
                            <div className="flex">
                                ...
                                <div className="ml-4">
                                    <h4 className="text-lg leading-6 font-medium text-gray-900">"Sage on the stage"</h4>
                                    <p className="mt-2 text-base leading-6 text-gray-500">
                        ...
                        <li className="mt-10 md:mt-0">
                            ...
                            <div className="flex">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="mt-2 text-base leading-6 text-gray-500">
                                        We teach every subject with a skills-based approach, challenging students to answer three fundamental questions based on critical thinking, comprehension and communication.
              </p>
                                </div>
                            </div>
                        </li>
