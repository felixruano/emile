                ...
                <div className="relative">
                    ...
                    <blockquote className="mt-8">
                        <div className="max-w-3xl mx-auto text-center text-2xl leading-9 font-medium text-gray-900">
                            <p>
                                &ldquo;Traditional education is not working. Legacy “factory model” classrooms treat students as passive receptacles of information. Instruction continues to emphasize core content remediation, while a rapidly changing labor market demands mastery of a foundational set of critical skills. Online efforts to individualize instruction fail because they continue to be content-focused and teacher-centric.  &rdquo;</p>
                        </div>
